...
function get20s(array) {
  ...
  for (let i = 0; i < array.length; i++){
    ...
    let birth = Number(yearArray[0]);
    let death = Number(yearArray[2]);

    if (1900 <= birth && death <= 1999){
...
// TEST
// console.log('Orig Length: ', artists.length);
// console.log('Orig Index 0:', artists[0].name);
// console.log('New Length: ', removeArtist(artists,0));
// console.log('New Index 0:', artists[0].name);
...
// TEST
// console.log('\n#6 Orig Length - 19: ', artists.length);
// console.log('#6 Orig Last Index - Albrecht: ', artists[artists.length-1].name);
// console.log('#6 CALL: ', addArtist(artists));
// console.log('#6 New Length - 20:', artists.length);
// console.log('#6 New Last Index - Sean:', artists[artists.length-1].name);
